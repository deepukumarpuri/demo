...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(strings["btn_source"], url="https://t.me/DKBOTZHELP"),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/DKBOTZ"),
        InlineKeyboardButton(strings["btn_group"], url="https://t.me/Dk_botz"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add DaisyX to your group",
            url=f"https://telegram.me/dkdemobot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/dkdemobot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
